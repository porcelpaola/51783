...
En la raíz del proyecto modificar el archivo input.txt colocando cualquiera de los cuatro ejemplos de códigos (input_correcto1, input_correcto2, input_incorrecto1, input_incorrecto2).
